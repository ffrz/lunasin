          ...
          <q-card square flat bordered class="col">
            ...
            <q-card-section class="q-pt-md">
              ...
              <q-select v-model="form.user_id" label="BS" :options="users" map-options emit-value
                v-show="$page.props.auth.user.role == $CONSTANTS.USER_ROLE_ADMIN" :error="!!form.errors.user_id"
                :disable="form.processing" :error-message="form.errors.user_id" />
              <q-select v-model="form.type_id" label="Kegiatan" :options="types" map-options emit-value
                :error="!!form.errors.type_id" :disable="form.processing" :error-message="form.errors.type_id" />
