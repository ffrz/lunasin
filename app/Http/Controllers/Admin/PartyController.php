...
class PartyController extends Controller
{
    ...
    {
        return inertia('admin/party/Index');
    }

    public function detail($id = 0)
    {
        return inertia('admin/party/Detail', [
            'data' => Party::with([
    ...
    public function duplicate($id)
    {
        ...
        return inertia('admin/party/Editor', [
            'data' => $item,
        ]);
    }
    ...
    public function save(Request $request)
    {
        ...
        return redirect(route('admin.party.detail', ['id' => $item->id]))->with('success', "Pelanggan $item->name telah disimpan.");
    }
